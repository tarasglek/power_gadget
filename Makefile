...
power_gadget_static:
	gcc $(CFLAGS) power_gadget.c -I. -o power_gadget -L. ./librapl.a -lm

power_gadget:
	gcc $(CFLAGS) power_gadget.c -I. -o power_gadget -L. -lrapl -lm
...
install:
	cp power_gadget /usr/sbin/
	cp -v *.socket *.service /etc/systemd/system
	systemctl daemon-reload
	systemctl enable power_gadget.socket
	systemctl start power_gadget.socket
	systemctl status power_gadget.socket